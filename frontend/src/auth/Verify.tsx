...
const Verify = () => {
    ...
    const handleVerify = async (e: React.FormEvent) => {
        ...
        if (!email) {
            setError("Email не указан. Пожалуйста, вернитесь к регистрации.");
            return;
        }
        try {
    ...
    if (!email) {
        return (
            <div className={styles.authContainer}>
                ...
                <p className={styles.errorText}>Email не указан. Пожалуйста, вернитесь к регистрации.</p>
                <button 
    ...
    return (
        ...
        >
            <h2 className={styles.authTitle}>Подтверждение Email</h2>
